...
@section('content')
    <main class="w-full pt-9 px-6 pb-9 font-sans max-h-[calc(100vh-56px)] overflow-y-auto overflow-x-hidden">
        ...
        <form action="{{ route(auth()->user()->role . '.peralatan.update', $peralatan->id_peralatan) }}" method="POST"
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                        <x-input name="gedung" id="gedung" label="Lokasi" required list="daftar-gedung"
                            autocomplete="off" placeholder="Ketik atau pilih gedung" value="{{ old('gedung', $peralatan->gedung) }}"
