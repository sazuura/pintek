@php
    // Sidebar dinamis tunggal - menggantikan sidebar-admin/operator/inventaris.blade.php
    // yang isinya dulu disalin identik bertiga. Daftar menu & urutannya diambil dari
    // tabel role_menu_akses (diatur lewat halaman Sistem Settings), bukan ditulis
    // literal per role di sini. Lihat docs/plans/planning-role-akses-dinamis.md §5.
    ...
    // dan pengaturan (route-nya bersarang lebih dalam) - lihat routes/web.php.
