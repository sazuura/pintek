...
class PeminjamanDiubahMail extends Mailable
{
    ...
    {
        return new Envelope(subject: "Pengajuan Peminjaman Diubah dari {$this->gedung}");
    }

    public function content(): Content
    {
        return new Content(view: 'mails.peminjaman-diubah');
    }
}
